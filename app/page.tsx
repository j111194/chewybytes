...
import { submitContactForm, subscribeToNewsletter } from "./actions"

export default function HomePage() {
  // This boolean controls whether to show download buttons or subscription form
  const isGameReleased = false
  // Control video autoplay
  const autoplayHeroVideo = false
  ...
  const handleSubscribeSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Reset form if successful
      if (result.success && subscribeFormRef.current) {
      ...
      setSubscribeStatus({ success: false, message: "An unexpected error occurred. Please try again." })
      setTimeout(() => setSubscribeStatus(null), 5000)
    } finally {
            ...
            <div className="flex flex-col gap-16 md:flex-row md:items-center">
              <div className="flex-1 space-y-8">
                ...
                <p className="text-xl text-navy/70">
                  A fast-paced platformer where your reflexes are put to the test. Navigate through challenging levels,
                  collect power-ups, and compete with friends on the global leaderboard.
                </p>
                ...
                {isGameReleased ? (
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-smooth max-w-md">
                    <h3 className="text-lg font-bold text-navy mb-3">Get notified when we launch!</h3>
                    <form ref={subscribeFormRef} onSubmit={handleSubscribeSubmit} className="flex gap-2">
                      <Input
                        name="email"
                      ...
                      <Button
                        type="submit"
                        className="btn-orange h-14 whitespace-nowrap"
                        disabled={isSubmittingSubscribe}
                      >
                        {isSubmittingSubscribe ? "Subscribing..." : "Subscribe"}
                      </Button>
                    </form>
                    {subscribeStatus && (
                      <div
                        className={`mt-3 p-2 rounded-lg text-sm ${
                          subscribeStatus.success ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                        }`}
                      >
                    ...
                    {autoplayHeroVideo ? (
                      ...
                      <>
                        ...
                        <Image
                          ...
                          alt="Pixel Jumper Game Screenshot"
                          width={280}
                          height={560}
        ...
        <section id="games" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
            <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-navy">My Games</h2>
              <p className="text-xl text-navy/70 max-w-[700px]">
                Check out my collection of mobile games, each crafted with love and attention to detail.
              </p>
            </div>

            <div className="space-y-16">
              {/* Dr. Chop */}
              <div className="flex flex-col md:flex-row gap-8 items-center bg-white rounded-2xl p-8 shadow-smooth">
                ...
                <div className="md:w-3/4 space-y-4 text-center md:text-left">
                  <div className="inline-block text-orange font-bold">Action Game</div>
                  <h3 className="text-3xl font-extrabold text-navy">Dr. Chop</h3>
                  <p className="text-navy/70">
                    Slice, dice, and chop your way to victory in this fast-paced action game. With precise swipes and
                    strategic timing, slice through waves of objects, avoid hazards, and rack up combos for high scores.
                  </p>
                  <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    <Link href="/games/dr-chop">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center bg-white rounded-2xl p-8 shadow-smooth">
                ...
                <div className="md:w-3/4 space-y-4 text-center md:text-left">
                  <div className="inline-block text-orange font-bold">Casual Game</div>
                  <h3 className="text-3xl font-extrabold text-navy">Don't Pop Bob</h3>
                  <p className="text-navy/70">
                    Guide Bob the balloon through a series of increasingly challenging environments filled with sharp
                    objects and hazards. Tap and hold to float higher, release to descend, and navigate carefully to
                    keep Bob intact!
                  </p>
                  <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    <Link href="/games/dont-pop-bob">
                      <Button variant="outline" className="btn-outline">
                        Learn More
                      </Button>
                    </Link>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center bg-white rounded-2xl p-8 shadow-smooth">
                ...
                <div className="md:w-3/4 space-y-4 text-center md:text-left">
                  <div className="inline-block text-orange font-bold">Arcade Game</div>
                  <h3 className="text-3xl font-extrabold text-navy">NeoDodge</h3>
                  <p className="text-navy/70">
                    Control your ship with precision as you navigate through an endless stream of neon obstacles. With
                    each level, the speed increases and the patterns become more complex in this synthwave-inspired
                    challenge.
                  </p>
                  <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    <Link href="/games/neo-dodge">
                      <Button variant="outline" className="btn-outline">
                        Learn More
                      </Button>
                    </Link>
        ...
        <section id="contact" className="w-full py-20 md:py-32 bg-navy/5">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
            <div className="flex flex-col items-center justify-center space-y-6 text-center mb-16">
              ...
              <p className="text-xl text-navy/70 max-w-[700px]">
                Have a question, feedback, or just want to say hello? Drop me a message!
              </p>
            </div>
